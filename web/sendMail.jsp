            ...
            <div id="menu-container">
                <div class="homepage home-section text-center">
                    <div class="welcome-text">
                        ...
                        <div class="row">
                            <form action="login.do?method=4" method="post">
                                <input type="text" name="account" style="color:#9d9d9d;" placeholder="请输入用户名.." required >
                                ...
                                <br><br><a href="index.html" style="font-weight: bolder;font-size: larger;border: black">返回登陆</a>
