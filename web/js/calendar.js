var cal;
  ...
  */
  function Calendar(beginYear, endYear, lang, dateFormatStyle) {
   ...
   "sat_word"      : "#ffff00",  //星期六文字颜色
   "td_word_light" : "#ffffff",  //单元格文字颜色
   "td_word_dark"  : "#CCCCCC",  //单元格文字暗色
   "td_bg_out"     : "#000000",  //单元格背影色
   "td_bg_over"    : "#FFCC00",  //单元格背影色
   "tr_word"       : "#ffffff",  //日历头文字颜色
   "tr_bg"         : "#666666",  //日历头背影色
   "input_border"  : "#000000",  //input控件的边框颜色
   "input_bg"      : "#666666"   //input控件的背影色
   }
  ...
  */
  ...
  Calendar.prototype.draw = function() {
   ...
   mvAry[mvAry.length]  = '        <th align="center" width="98%" nowrap="nowrap">&nbsp;&nbsp;&nbsp;&nbsp;<select name="calendarYear" id="calendarYear" style="color:black;font-size:12px;"></select>&nbsp;&nbsp;&nbsp;&nbsp;<select name="calendarMonth" id="calendarMonth" style="color:black;font-size:12px;"></select></th>';
