            ...
            <div id="menu-container">
                <div class="homepage home-section text-center">
                    <div class="welcome-text">
                        <h2><strong>---订单数量修改---</strong></h2>
                        <div class="row">
                            <form action="/modif.do?name=<%out.print(name);%>&id=<%=id%>&method=2" method="post">
                            <table  cellSpacing=0 cellPadding=0 width="100%" border="5">
                                ...
                                <tr >
                                    ...
                                    <td  align="center">修改票数</td>

                                </tr>
                                <%
                                    TicketDao ticketDao = new TicketDao();
                                    String sql="select * from yuding where id ='"+id+"'";
                                    List list2=ticketDao.getTicket(sql);
                                ...
                                <tr  class="trA" onMouseOver="this.className='trB'" onMouseOut="this.className='trA'">
                                    ...
                                    <td align="center"   style="border-bottom:1px dotted #ccc;"><%=listt.get(11).toString() %></td>
                                    <td align="center"   style="border-bottom:1px dotted #ccc;"><%=listt.get(9).toString() %></td>
                                    <td align="center"   style="border-bottom:1px dotted #ccc;"><input width="100%" style="background: none;border: none;color: white;text-align:center;"  placeholder="请输入修改后的票数.." type="text" name="piaoshu" onfocus="this.placeholder=''" onblur="this.placeholder='请输入修改后的票数..'"></td>
                                </tr>
                                <%}} %>
                                </tbody>
                            </table>
